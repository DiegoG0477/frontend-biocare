        ...
        <div style={{display:"flex", flexFlow:'column wrap', justifyContent:'space-evenly'}}>
            ...
            <div style={{margin: "auto", justifyContent:"space-around", width:'fit-content'}}>
                <DataTable value={users} tableStyle={{minWidth:'50rem', textAlign:'center'}}  paginator rows={20} paginatorTemplate="FirstPageLink PrevPageLink PageLinks NextPageLink LastPageLink CurrentPageReport RowsPerPageDropdown">
                    <Column field={'id'} header={"ID"} headerStyle={{backgroundColor:'#1D3557', color:"white", padding:' 10px 0 10px 0'}} bodyStyle={{paddingTop: '20px'}} />
                    <Column field={'correo'} header={"Correo"} headerStyle={{backgroundColor:'#1D3557', color:"white", padding:' 10px 0 10px 0'}} bodyStyle={{paddingTop: '20px'}} />
                    ...
                    <Column field={'apellido'} header={"Apellido"} headerStyle={{backgroundColor:'#1D3557', color:"white", padding:' 10px 0 10px 0'}} bodyStyle={{paddingTop: '20px'}} />
                    <Column field={'rol'} header={"Rol"} headerStyle={{backgroundColor:'#1D3557', color:"white", padding:' 10px 0 10px 0'}} bodyStyle={{paddingTop: '20px'}} />
